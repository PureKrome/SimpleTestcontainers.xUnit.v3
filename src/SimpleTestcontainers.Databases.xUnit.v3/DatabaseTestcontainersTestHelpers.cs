...
using SimpleTestcontainers.Databases.xUnit.v3;
using Xunit;

namespace WorldDomination.SimpleTestcontainers.Databases.xUnit.v3;

public static class DatabaseTestcontainersTestHelpers
{
    /// <summary>
    /// Creates a connection string which will be for a unique DB that is based off the test name.
    /// </summary>
    /// <param name="databaseTestcontainerFixture">The custom Testcontainers SqlServer fixture</param>
    ...
    public static string CreateDbConnectionString(
        this IDatabaseTestcontainerFixture databaseTestcontainerFixture,
        ITestContext testContext,
        ITestOutputHelper? testOutputHelper = null) => databaseTestcontainerFixture.CreateDbConnectionString(
        ...
        ITestOutputHelper? testOutputHelper)
    {
        ...
        // ⭐⭐ This is the magic
        var connectionString = new SqlConnectionStringBuilder(databaseTestcontainerFixture.ConnectionString)
        {
