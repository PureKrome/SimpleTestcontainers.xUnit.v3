...
public static class PostgreSqlTestHelpers
{
    private static string CreateUniqueConnectionString(
        string connectionString,
        string uniqueDatabaseName)
    {
        var uniqueConnectionString = new NpgsqlConnectionStringBuilder(connectionString)
        {
    ...
    /// </summary>
    /// <param name="postgreSqlFixture">The custom Testcontainers SqlServer fixture</param>
    ...
    public static UniqueConnectionStringInfo CreateUniqueConnectionStringInfo(
        ...
        ITestOutputHelper? testOutputHelper = null) => postgreSqlFixture.CreateUniqueConnectionStringInfo(
    ...
    public static UniqueConnectionStringInfo CreateUniqueConnectionStringInfo(
        ...
        postgreSqlFixture.CreateUniqueConnectionStringInfo(
            databaseName,
